...
public class MagicAnimalEarFilter extends GPUImageFilter {
    ...
    private static final String TAG = "MagicAnimalEarFilter";

    public MagicAnimalEarFilter(){
    ...
    protected void onInitialized(){
        ...
        runOnDraw(new Runnable(){
            public void run(){
                inputTextureHandles[0] = OpenGlUtils.loadTexture(MagicParams.context, "filter/animalear.png");
                inputTextureHandles[1] = OpenGlUtils.loadTexture(MagicParams.context, "filter/animalear.png");
                inputTextureHandles[2] = OpenGlUtils.loadTexture(MagicParams.context, "filter/animalear.png");
                inputTextureHandles[3] = OpenGlUtils.loadTexture(MagicParams.context, "filter/animalear.png");
            }
        });
    }
    ...
    public int onDrawFrame(final int textureId, final FloatBuffer cubeBuffer,
        ...
        if (numFaces == 0) {
            ...
            for (int i = 0; i < numFaces; i++) {
                ...
                /*sPos[i][4] = (float) ((-0.5 * 720 + 0.5 * 960 + 160 * 1.414) / 320 / 1.414);
                sPos[i][5] = (float) (-(0.5 * 720 + 0.5 * 960 + 160 * 1.414) / 320 / 1.414);
                sPos[i][0] = (float) ((0.5 * 720 + 0.5 * 960 + 160 * 1.414) / 320 / 1.414);
                sPos[i][1] = (float) ((0.5 * 720 - 0.5 * 960 - 160 * 1.414) / 320 / 1.414);
                sPos[i][6] = (float) ((-0.5 * 720 - 0.5 * 960 + 160 * 1.414) / 320 / 1.414);
                sPos[i][7] = (float) ((-0.5 * 720 + 0.5 * 960 - 160 * 1.414) / 320 / 1.414);
                sPos[i][2] = (float) ((0.5 * 720 - 0.5 * 960 + 160 * 1.414) / 320 / 1.414);
                sPos[i][3] = (float) ((0.5 * 720 + 0.5 * 960 - 160 * 1.414) / 320 / 1.414);*/
            }
